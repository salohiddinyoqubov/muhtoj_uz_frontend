...
const PaymentApplicationById: React.FC<PaymentApplicationProps> = ({ applicationId, onCloseModal, isOpen }) => {
    ...
    return (
        ...
        >
            <h2>Ehson qilish ID: {applicationId}</h2>
            ...
            <input ref={amountInputRef} type="text" placeholder="Yordam summasini:" value={formatAmount(amount)} onChange={e => setAmount(e.target.value)} />
...
export default PaymentApplicationById;
